...
public class GraffitiSubmissionActivity extends Activity {
    ...
    private void fillFormFields() {
        ...
        String script =
            ...
            "var input=document.getElementById('fileupload');if(input&&window.DataTransfer&&!window.__graffitiHunterFilesAttached){" +
            "window.__graffitiHunterFilesAttached=true;" +
