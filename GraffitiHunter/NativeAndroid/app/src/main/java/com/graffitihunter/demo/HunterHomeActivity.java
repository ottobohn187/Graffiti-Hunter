...
public class HunterHomeActivity extends Activity {
    ...
    private void drawHome() {
        ...
        TextView title = label("GRAFFITI HUNTER", 24, true);
        ...
        TextView build = label("BUILD 0.5.7", 13, true);
        ...
        projectSite.setContentDescription("Open the Graffiti Hunter project website");
        projectSite.setOnClickListener(v -> {
            Intent site = new Intent(Intent.ACTION_VIEW,
                Uri.parse("https://graffitihunter.net/"));
            startActivity(site);
        });
        page.addView(projectSite, full(dp(68)));

        TextView note = label("Graffiti Hunter is an independent home-made field reporting project. Visit graffitihunter.net for project information.\n\nYour Get It Done session is kept in the app. Android Autofill or Samsung Pass can securely remember your email and password.", 14, false);
