# Graffiti Hunter Native Android

This is the standalone Android implementation of Graffiti Hunter. It does not
...
packages under the app's external `GraffitiReports` directory.
